...
const Slogan = () => {
  return (
    <section className="flex justify-center items-center py-12 md:px-10 font-serif">
      <div className="relative  w-[96%] bg-white border border-gray-200 bg-cover bg-center py-6 flex flex-col items-center justify-center text-center rounded-lg shadow-[0_6px_20px_rgba(0,0,0,0.2)]">
        <motion.div
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-gray-800 max-w-3xl text-[28px] mb-8 md:mb-12 px-4"
        >
