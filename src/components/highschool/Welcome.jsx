  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 relative flex justify-center">
        <motion.img
          src="/highschool/Empowering Minds.jpg"
          alt="Graduation caps"
        ...
        <motion.div
          className="bg-white w-[80px] sm:w-[150px] h-[80px] sm:h-[110px] absolute -left-4 -bottom-4 flex justify-center items-center rounded-tr-[100px]"
