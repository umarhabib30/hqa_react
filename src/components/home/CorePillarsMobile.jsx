        ...
        <div className="flex-grow relative overflow-hidden mb-8">
          ...
          >
            {pillars.map((pillar, i) => (
              ...
              >
                {/* Bigger Image */}
                <div className="w-full h-[45vh] sm:h-[55vh] relative mb-0">
                  <img
                    src={pillar.img}
                    alt={pillar.title}
                ...
                {/* Taller, Rounded Card */}
                <div className="bg-[#00285EE5] text-white p-6 w-full rounded-3xl mt-1 z-30 min-h-[230px] flex flex-col">
                  <h3 className="p font-normal mb-2">{pillar.title}</h3>
                  <p className="p leading-relaxed flex-grow">{pillar.text}</p>
                </div>
              </div>
            ))}
          </motion.div>
