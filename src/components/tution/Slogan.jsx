...
const Slogan = () => {
  return (
    <section className="relative bg-[#C8E1F8]  py-12  px-10 flex items-center justify-center text-center font-serif  overflow-hidden">
      <div className="relative w-full  flex flex-col items-center justify-center">
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-black max-w-5xl slogan px-4 md:px-6 mb-4"
        >
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-[#00285E] max-w-3xl font-bold text-[28px] italic mb-8 md:mb-12 px-4"
        >
